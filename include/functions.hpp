              ...
              w *
                  (563249.531577994933 +
                   s * (348717.634501234702 +
                        s * (40765.2886083808789 + s * 865.059113888543852))) /
                  (90262.6676538587293 +
              ...
              w *
                  (12264.3569103180524 +
                   s * (3204.34872454052352 +
                        s * (140.119604748253961 + s * 0.523918919699235590))) /
                  (9877.87829948067200 +
              ...
              ex *
                  (1346.14119046566636 +
                   t * (199.946876779712712 +
                        t * (6.5210149677288048 + t * 0.0108588591982722183))) /
                  (5728.3481201778541 +
                   t * (1132.17837281710987 + t * (64.805243148002602 + t))));
    }
    else if (x < 0.)
    {
        s = -0.5 * x;
             ...
             ex *
                 (3004.41138112148735 +
                  t * (409.582975848055860 +
                       t * (12.3422465543050559 + t * 0.0252600128832787650))) /
                 (10227.9400759349389 +
                  t * (1729.21912667445507 + t * (82.075224736463695 + t))));
    }
    else if (x < 0.)
    {
        s = -0.5 * x;
              ...
              ex *
                  (9371.8868848378853 +
                   t * (1152.33581795824468 +
                        t * (31.4225568934398918 + t * 0.069508514261022902))) /
                  (18231.3053891121107 +
                   t * (2639.60073595942887 + t * (103.985056337236794 + t))));
    }
    else if (x < 0.)
    {
        s = -0.5 * x;
...
double FDI_p4(const double y)
{
              ...
              ex *
                  (18247.2542465629199 +
                   t * (2120.56302902849207 +
                        t * (54.659507299984584 + t * 0.121876197098273914))) /
                  (24329.6723287505678 +
                   t * (3261.01909656925521 + t * (117.071576489684022 + t))));
    }
    else if (x <= 0.)
    {
        s = -0.5 * x;
    ...
    if (y > 0.)
    {
        y2 = y * y;
        fd = fd +
             y * (45.4575758158678040 + y2 * (6.57973626739290575 + y2 * 0.2));
    }
              ...
              ex *
                  (37544.8291647986266 +
                   t * (4113.48125371067712 +
                        t * (99.866490020209337 + t * 0.221035794126711913))) /
                  (32460.7344732907336 +
                   t * (4028.81223496037193 + t * (131.831032502212893 + t))));
    }
    else if (x < 0.)
    {
        s = -0.5 * x;
              ...
              ex *
                  (81190.938912603315 +
                   t * (8368.4990332049831 +
                        t * (190.753830813273698 + t * 0.413800735538960261))) /
                  (43301.8340867217726 +
                   t * (4977.68099709243407 + t * (148.484432990224213 + t))));
    }
    else if (x <= 0.)
    {
        s = -0.5 * x;
              ...
              ex *
                  (183706.438585548927 +
                   t * (17781.2198813711389 +
                        t * (379.468701417596835 + t * 0.79823396490661890))) /
                  (57756.370490854840 +
                   t * (6150.6214356632731 + t * (167.282750039076672 + t))));
    }
    else if (x < 0.)
    {
        s = -0.5 * x;
...
double FDI_p6(const double y)
{
              ...
              ex *
                  (433290.557356514403 +
                   t * (39323.1678283287030 +
                        t * (783.71684376947655 + t * 1.58412947146158337))) /
                  (77029.432418935897 +
                   t * (7600.9245809611507 + t * (188.511069473956679 + t))));
    }
    else if (x <= 0.)
    {
        s = -0.5 * x;
    ...
    if (y > 0.)
    {
        ...
        fd =
            fd +
            y * (1419.19357146830655 +
                 y2 * (227.287879079339020 +
                       y2 * (9.86960440108935862 + y2 * 0.142857142857142857)));
    }
...
double FDI_p10(const double y)
{
    ...
    if (x < -2.)
    {
        ...
        fd = ex *
             (3628800. - ex * (1769.11836499240874 +
