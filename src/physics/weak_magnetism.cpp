...
#include "parameters.hpp" //Header file containing all relevant constants
#include "nucfrmfac.hpp" //Header file for computation of nucleon form factors
...
double WM_nue_abs(const double e_nu)
{
	...
	const double ehor = e_nu * MeV/(mb*c*c);
