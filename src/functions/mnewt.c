...
// Ansatz for neutrino distribution function in optically thick and thin
...
//  fjac[0]
//  = 4.*pi*exp(Gammln(x[0]+3.))/pow(x[1],x[0]+3.)*(log(x[1])-SFPsi(x[0]+3.));
//  fjac[1] = 4.*pi*(x[0]+3.)*exp(Gammln(x[0]+3.))/pow(x[1],x[0]+4.);
//  fjac[2]
//  = 4.*pi*exp(Gammln(x[0]+4.))/pow(x[1],x[0]+4.)*(log(x[1])-SFPsi(x[0]+4.));
//  fjac[3] = 4.*pi*(x[0]+4.)*exp(Gammln(x[0]+4.))/pow(x[1],x[0]+5.);
//  //fjac[0]
//  = 4.*pi*exp(gammln(x[0]+3.)/pow(x[1],x[0]+3.)*(log(x[1])-gsl_sf_psi(x[0]+3.));
//  //fjac[1] = 4.*pi*(x[0]+3.)*exp(gammln(x[0]+3.)/pow(x[1],x[0]+4.);
//  //fjac[2]
//  = 4.*pi*exp(gammln(x[0]+4.)/pow(x[1],x[0]+4.)*(log(x[1])-gsl_sf_psi(x[0]+4.));
//  //fjac[3] = 4.*pi*(x[0]+4.)*exp(gammln(x[0]+4.)/pow(x[1],x[0]+5.);
//  return;
//}
