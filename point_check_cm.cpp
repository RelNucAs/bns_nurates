        ...
        for (r = 0; r < 6; ++r)
        {
            ...
            for (i = 0; i < 6; ++i)
            {
                ...
                my_grey_opacity_params.m1_pars.chi[id_anux] =
                    0.333333333333333333333333333;
                my_grey_opacity_params.m1_pars.J[id_nue] *= kMeV;
                my_grey_opacity_params.m1_pars.J[id_anue] *= kMeV;
                my_grey_opacity_params.m1_pars.J[id_nux] *= kMeV;
                my_grey_opacity_params.m1_pars.J[id_anux] *= kMeV;
                ...
                n_anue = yanue[i] * nb;
                n_nux  = ynux[i] * nb;
                j_nue  = znue[i] * nb * kMeV;
                j_anue = zanue[i] * nb * kMeV;
                j_nux  = znux[i] * nb * kMeV;
