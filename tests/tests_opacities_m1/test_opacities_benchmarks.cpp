...
void TestM1OpacitiesBenchmarks(int nx, int mb_nx) {
  ...
  Kokkos::View<double*, LayoutWrapper, DevMemSpace> mb_d_rho("mb_d_rho", npts);
  ...
  Kokkos::View<double*, LayoutWrapper, DevMemSpace> mb_d_mu_e("mb_d_mu_e", npts);
  Kokkos::View<double*, LayoutWrapper, DevMemSpace> mb_d_mu_hat("mb_d_mu_hat", npts);
  ...
  Kokkos::parallel_for("test_opacities_benchmarks_compute_opacities_loop",
