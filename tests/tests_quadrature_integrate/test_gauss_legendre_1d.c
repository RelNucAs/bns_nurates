...
int main() {
  ...
  double points_4[4] = {-(1. / 35.) * sqrt(525. + 70. * sqrt(30.)), -(1. / 35.) * sqrt(525. - 70. * sqrt(30.)), (1. / 35.) * sqrt(525. - 70. * sqrt(30.)),
                        (1. / 35.) * sqrt(525. + 70. * sqrt(30.))};
  double w_4[4] = {(1. / 36.) * (18. - sqrt(30.)), (1. / 36.) * (18. + sqrt(30.)), (1. / 36.) * (18. + sqrt(30.)), (1. / 36.) * (18. - sqrt(30.))};
  double max_error = -42.;
