                            ...
                            OpacityParams* opacity_pars)
{
    ...
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_mu_hat("mu_hat",
                                                               num_data);
    ...
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_em_nue("em_nue",
                                                               num_data);
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_l_nue_inv("l_nue_inv",
                                                                  num_data);
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_em_anue("em_anue",
                                                                num_data);
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_l_anue_inv("l_anue_inv",
                                                                   num_data);
    ...
    Kokkos::View<double*, LayoutWrapper, HostMemSpace> h_weights("h_weights",
                                                                 my_quad.nx);
    Kokkos::View<double*, LayoutWrapper, HostMemSpace> h_points("h_points",
                                                                my_quad.nx);

    Kokkos::View<int*, LayoutWrapper, DevMemSpace> d_n_quad("n_quad", 1);
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_weights("weights",
                                                                my_quad.nx);
    Kokkos::View<double*, LayoutWrapper, DevMemSpace> d_points("points",
                                                               my_quad.nx);
