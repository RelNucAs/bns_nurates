...
int main(int argc, char* argv[])
{
    ...
    printf("----------------\n");
    printf(
        "Neutrino energy (for spectral rates)               : %13.6e (MeV)\n",
        nu_energy);
    printf(
        "Baryon number density                              : %13.6e (cm^-3)\n",
        nb);
    printf(
        "Temperature                                        : %13.6e (MeV)\n",
        T);
    ...
    printf(
        ...
        mu_p);
    printf(
        "Relativistic neutron chemical potential            : %13.6e (MeV)\n",
        mu_n);
    printf(
        "Effective nucleon mass difference (n - p)          : %13.6e (MeV)\n",
        dm);
    printf(
        "Effective nucleon potential difference (n - p)     : %13.6e (MeV)\n",
        dU);
    printf(
        "Electron neutrinos number density 'n'              : %13.6e (cm^-3)\n",
        n_nue);
    printf(
    ...
    // N.B.: they are required for the normalization factor of energy-averaged
    // opacities,
    ...
    // N.B.: 'j' and 'kappa' are the spectral emissivities and inverse mean free
    // paths for the
